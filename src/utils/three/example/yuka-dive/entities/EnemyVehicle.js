...
export default class EnemyVehicle extends YUKA.Vehicle {
  ...
  start() {
    ...
    const run = this.animationMaps.get('soldier_idle');
  ...
  atPosition(position) {
    const tolerance =
      GameConfig.BOT.NAVIGATION.ARRIVE_TOLERANCE * GameConfig.BOT.NAVIGATION.ARRIVE_TOLERANCE;

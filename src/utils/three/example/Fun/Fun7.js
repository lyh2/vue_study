...
export class TslAngularSlicing {
  ...
  _init(params = {}) {
    ...
    this._gui
      .addColor({ color: sliceColor.value.getHexString(THREE.SRGBColorSpace) }, 'color')
...
export class TslEarth {
  constructor(_options = {}) {
    ...
    const bumpRoughnessCloudsTexture = loader.load(
      './textures/planets/earth_bump_roughtness_clouds_4096.jpg'
    );

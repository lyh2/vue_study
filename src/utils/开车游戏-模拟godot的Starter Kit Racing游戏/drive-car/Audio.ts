...
export class GameAudio {
  ...
  public engineSound: THREE.Audio;
  public skidSound: THREE.Audio;
  public impactBuffer: any;
  public impactPool: Array<THREE.Audio>;
  public impactIndex: number;
  ...
  init(camera) {
    ...
    loader.load('./开车游戏-模拟godot的Starter Kit Racing游戏/audio/engine.ogg', buffer => {
    ...
    loader.load('./开车游戏-模拟godot的Starter Kit Racing游戏/audio/skid.ogg', buffer => {
    ...
    loader.load('./开车游戏-模拟godot的Starter Kit Racing游戏/audio/impact.ogg', buffer => {
